package otang.crashreport.activity;
...
import otang.crashreport.config.CrashConfig;

public final class CrashActivity {

  private static final String TAG = "CrashActivity";
  // Extras passed to the error activity
  private static final String EXTRA_CONFIG = "otang.crashreport.EXTRA_CONFIG";
  private static final String EXTRA_STACK_TRACE = "otang.crashreport.EXTRA_STACK_TRACE";
  private static final String EXTRA_ACTIVITY_LOG = "otang.crashreport.EXTRA_ACTIVITY_LOG";
  // General constants
  private static final String INTENT_ACTION_ERROR_ACTIVITY = "otang.crashreport.ERROR";
  private static final String INTENT_ACTION_RESTART_ACTIVITY = "otang.crashreport.RESTART";
  private static final String CRASH_HANDLER_PACKAGE_NAME = "otang.crashreport.";
  private static final String DEFAULT_HANDLER_PACKAGE_NAME = "com.android.internal.os";
  private static final int MAX_STACK_TRACE_SIZE = 131071; // 128 KB - 1
  private static final int MAX_ACTIVITIES_IN_LOG = 50;
  // Shared preferences
  private static final String SHARED_PREFERENCES_FILE = "otang.crashreport_preferences";
  ...
  public static void install(@Nullable final Context context) {
    try {
      if (context == null) {
        ...
        if (oldHandler != null
            && oldHandler.getClass().getName().startsWith(CRASH_HANDLER_PACKAGE_NAME)) {
          ...
          Thread.setDefaultUncaughtExceptionHandler(
              (thread, throwable) -> {
                if (config.isEnabled()) {
                  Log.e(
                      TAG,
                      "App has crashed, executing CrashActivity's UncaughtExceptionHandler",
                      throwable);
  ...
  @NonNull
  public static String getAllErrorDetailsFromIntent(
  ...
  private static void restartApplicationWithIntent(
      @NonNull Activity activity, @NonNull Intent intent, @NonNull CrashConfig config) {
    intent.addFlags(
  ...
  @Nullable
  private static String getBuildDateAsString(
